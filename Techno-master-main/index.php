...
<div class="row">
<div class="col-lg-6">
<span class="logo">Techno Master</span></div>
...
<div class="col-md-4 panel" style="background-color:lightblue;"> 
...
elseif (@$_GET['q77']) {
  echo '<p style="color:red;font-size:15px;">' . @$_GET['q77'];
}
elseif (@$_GET['q17']) {
  echo '<p style="color:red;font-size:15px;">' . @$_GET['q17'];
}
elseif (@$_GET['q07']) {
  echo '<p style="color:red;font-size:15px;">' . @$_GET['q07'];
}
elseif (@$_GET['q71']) {
  echo '<p style="color:red;font-size:15px;">' . @$_GET['q71'];
}
elseif (@$_GET['q27']) {
  echo '<p style="color:red;font-size:15px;">' . @$_GET['q27'];
}
?></div>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="name" name="name" required placeholder="Enter your name" class="form-control input-md" type="text" value="<?php
if (isset($_GET['name']))
{
echo $_GET['name'];
}?>">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" required placeholder="Enter your Roll no (Ex.1DT20IS***)" class="form-control input-md" type="text" value="<?php
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="phno" name="phno" required placeholder="Enter your mobile number" class="form-control input-md" type="number" value="<?php
if (isset($_GET['phno']))
{
echo $_GET['phno'];
};
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="password" name="password" required placeholder="Enter your password" class="form-control input-md" type="password" value="<?php
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <input id="cpassword" required name="cpassword" required placeholder="Confirm Password" class="form-control input-md" type="password" value="<?php
...
<div class="col-md-3 box">
<span href="#" data-target="#login" style="color:lightyellow">Organized by Dsatm<br><br></span>
</div>
