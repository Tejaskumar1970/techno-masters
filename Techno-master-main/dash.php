...
<title> Admin || Techno Masters</title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Techno Masters</span></div>
<?php
...
<style>
    .navbar-nav > li:hover {
        background-color: #f5f5f5; /* Change to the desired highlight color */
    }
</style>
</div></div>
...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>Subject</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Date</b></td><td style="vertical-align:middle"><b>Time</b></td><td style="vertical-align:middle"><b>By</b></td><td style="vertical-align:middle"></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        // echo '<td style="vertical-align:middle">' . $ease . '</td>';
        // echo '<td style="vertical-align:middle">' . $content . '</td>';
        // echo '<td style="vertical-align:middle">' . $feedbackk . '</td>';
        // echo '<td style="vertical-align:middle">' . $improvement . '</td>';
        echo '<td style="vertical-align:middle"><a title="Open Feedback" href="dash.php?q=3&fid=' . $id . '"><b><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></b></a></td>';
        echo '<td style="vertical-align:middle"><a title="Delete Feedback" href="update.php?fdid=' . $id . '"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td></tr>';
    }
    echo '</table></div>';
}
if (@$_GET['fid']) {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo '<div class="panel"><a title="Back to Archive" href="update.php?q1=2"><b><span class="glyphicon glyphicon-level-up" aria-hidden="true"></span></b></a><h2 style="text-align:center; margin-top:-15px;font-family: "Ubuntu", sans-serif;"><b>' . $subject . '</b></h2>';
        echo '<div class="panel"><h2 style="text-align:center; margin-top:-15px;font-family: "Ubuntu", sans-serif;"><b>Feedback Details</b></h2>';
...
<span style="line-height:35px;padding:5px;">&nbsp;<b>By:</b>&nbsp;' . $name . '</span><br />
<span style="line-height:35px;padding:5px;"><b>Ease:</b> ' . $ease . '</span><br />
<span style="line-height:35px;padding:5px;"><b>Content:</b> ' . $content . '</span><br />
<span style="line-height:35px;padding:5px;"><b>Feedback:</b> ' . $feedbackk . '</span><br />
<span style="line-height:35px;padding:5px;"><b>Improvement:</b> ' . $improvement . '</span><br />
<span style="line-height:35px;padding:5px;"><b>Message:</b> ' . $feedback . '</span><br />
</div></div>';
}
}
