...
if (@$_GET['q'])
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="form-group">
                ...
                <input id="subject" name="subject" placeholder="Enter short description of your feedback" class="form-control input-md" type="text" required>    
            </div>
        </div>
    </div><!--End of row-->
    ...
    <!-- Additional feedback questions with dropdown menus -->
    <div class="form-group">
        <label for="ease">Ease of using the quiz: *</label><br />
        <select id="ease" name="ease" class="form-control" required>
    ...
    <div class="form-group">
        <label for="content">Relevance of quiz content: *</label><br />
    ...
    <div class="form-group">
        <label for="feedbackk">Overall feedback on the quiz: *</label><br />
        <select id="feedbackk" name="feedbackk" class="form-control" required>
            <option value="">Select option</option>
    ...
    <div class="form-group">
        <label for="improvement">Suggestions for quiz improvement:</label><br />
        <select id="improvement" name="improvement" class="form-control" required>
            <option value="">Select option</option>
            <option value="more-topics">Include more topics</option>
            <option value="better-instructions">Provide better instructions</option>
            <option value="additional-resources">Add additional resources</option>
        </select>
    </div>
    <div class="form-group"> 
    <label for="improvement">Would you like to add a comment (Optional):</label><br />
