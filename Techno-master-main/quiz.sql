...
CREATE TABLE `feedback` (
  ...
  `ease` varchar(500) NOT NULL,
  `content` varchar(500) NOT NULL,
  `feedbackk` varchar(500) NOT NULL,
  `improvement` varchar(500) NOT NULL,
  `date` date NOT NULL,
...
INSERT INTO `feedback` (`id`, `name`, `username`, `subject`, `feedback`, `ease`, `content`, `feedbackk`, `improvement`, `date`, `time`) VALUES
('5b86784504039', 'pravin', 'fyvgh@vgyvy.in', 'ytiu', 'yty', 'Easy', 'Relevant', 'Positive', 'Include more topics', '2018-08-29', '03:41:09pm');
